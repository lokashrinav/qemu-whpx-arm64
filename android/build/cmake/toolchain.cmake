...
function(_get_host_tag RET_VAL)
  ...
  elseif(UNIX)
    ...
    string(TOLOWER "$ENV{PROCESSOR_ARCHITECTURE};$ENV{PROCESSOR_ARCHITEW6432}"
           WINDOWS_HOST_ARCH)
    if(WINDOWS_HOST_ARCH MATCHES "arm64")
      set(${RET_VAL} "windows_msvc-aarch64" PARENT_SCOPE)
    else()
...
function(toolchain_configure_tags tag)
  ...
  elseif(ANDROID_TARGET_TAG STREQUAL "windows_msvc-aarch64")
    set(WINDOWS TRUE PARENT_SCOPE)
    set(WINDOWS_MSVC_AARCH64 TRUE PARENT_SCOPE)
  ...
  elseif(ANDROID_HOST_TAG STREQUAL "windows_msvc-aarch64")
    set(HOST_WINDOWS_MSVC_AARCH64 TRUE PARENT_SCOPE)
    set(HOST_WINDOWS TRUE PARENT_SCOPE)
