...
{
    tcg_allowed = true;
    fprintf(stderr, "DBG[translate-all.c]: cpu_gen_init...\n"); fflush(stderr);
    cpu_gen_init();
    fprintf(stderr, "DBG[translate-all.c]: page_init...\n"); fflush(stderr);
    page_init();
    fprintf(stderr, "DBG[translate-all.c]: tb_htable_init...\n"); fflush(stderr);
    tb_htable_init();
    fprintf(stderr, "DBG[translate-all.c]: code_gen_alloc(%lu)...\n", tb_size); fflush(stderr);
    code_gen_alloc(tb_size);
    fprintf(stderr, "DBG[translate-all.c]: code_gen_alloc done\n"); fflush(stderr);
#if defined(CONFIG_SOFTMMU)
    fprintf(stderr, "DBG[translate-all.c]: tcg_prologue_init...\n"); fflush(stderr);
    tcg_prologue_init(tcg_ctx);
    fprintf(stderr, "DBG[translate-all.c]: tcg_prologue_init done\n"); fflush(stderr);
#endif
}
